...
model_name = "/home/marrtino/src/marrtinorobot2/marrtinorobot2_chatbot/modelli_locali/geppetto"

# Caricamento del tokenizer e del modello locale
tokenizer = AutoTokenizer.from_pretrained(model_name)
tokenizer.add_special_tokens({'pad_token': '[PAD]'})  # Aggiunge il token di padding
