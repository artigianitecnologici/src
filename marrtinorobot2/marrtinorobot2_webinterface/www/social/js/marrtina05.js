class EyeController {
  ...
  normal() {
	    ...
	    document.getElementById("occhiodx").src = "image/face05/BulbDx.png"; 
    	document.getElementById("occhiosx").src = "image/face05/BulbSx.png"; 	
    	document.getElementById("bocca").src = "image/face05/boccastabile.png"; 
  ...
  happy() {
      ...
      document.getElementById("soprsx").src = "image/eyebrowdx1.gif"; 
	    document.getElementById("occhiodx").src = "image/face05/BulbDx.png"; 
    	document.getElementById("occhiosx").src = "image/face05/BulbSx.png"; 
      document.getElementById("bocca").src = "image/face05/boccaaperta.png"; 
  ...
  angry() {
      ...
      document.getElementById("occhiodx").src = "image/face05/BulbDx.png"; 
    	document.getElementById("occhiosx").src = "image/face05/BulbSx.png"; 
    	document.getElementById("bocca").src = "image/face05/boccasad.png"; 
  ...
  speak() {
    document.getElementById("bocca").src = "image/face05/talk3.gif"; 
    document.getElementById("naso").src = "image/nosetalkmarrtina1.gif"; 
  }	
