...
<p class="breadcrumb"><a href="/">home</a> <?php if($gallery_url!=''){ ?>&gt; <a href="<?php echo $gallery_url;?>">gallery</a> <?php } ?>&gt; <a href="<?php echo $gallery_url;?>/admin">admin</a> &gt; categories</p>
...
<p class="message_error">error: the directory that stores all your categories and photos is not writable, please make this folder writable on the server: <strong>/files </strong>
<br />On most servers that is done by setting permission code 775 or 777 on the <strong>/files</strong> folder, using a FTP program or the file manager from your web hosting panel.</p>
<?php } ?>
